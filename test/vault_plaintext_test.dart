...
void main() {
  const path = './test_vault/plaintext';
  const pwd = '';
  const id = 'VaultId';
  ...
  test('Setup a plaintext vault', () async {
    Vault vault = Vault(path: path, encrypted: false);
  ...
  test('Open a plaintext vault', () async {
    Vault vault = Vault(path: path, encrypted: false);
    await vault.init();
  ...
  test('Can not treat as encrypted vault', () async {
